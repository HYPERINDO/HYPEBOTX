...
module.exports = {
  ...
  async execute(interaction, client) {
    if (!isOwnerOrStaff(interaction.member)) {
      await safeReply(interaction, { content: "Hanya staff yang bisa set payment.", flags: MessageFlags.Ephemeral });
      return;
    }
    ...
    await safeReply(interaction, { content: `Payment setting tersimpan. Updated: ${settings.updatedAt}`, flags: MessageFlags.Ephemeral });
  },
};
