...
module.exports = {
  data: new SlashCommandBuilder().setName("skip").setDescription("Lewati track sekarang."),
  async execute(interaction, client) {
    ...
    const result = await client.container.services.musicService.skip(interaction.guild.id);
    await interaction.reply(result ? "Track dilewati." : "Queue musik kosong.");
  },
};
