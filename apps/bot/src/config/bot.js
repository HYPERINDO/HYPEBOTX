...
const repoRootPath = path.resolve(rootPath, "..", "..");
const envFile = process.env.ENV_FILE || ".env.local";
const envCandidates = [
  path.join(rootPath, envFile),
  path.join(rootPath, ".env"),
  path.join(repoRootPath, envFile),
  path.join(repoRootPath, ".env.local"),
  path.join(repoRootPath, ".env"),
];
...
module.exports = {
  ...
  paths: {
    ...
    docs: path.join(repoRootPath, "docs"),
    storage: {
      root: storagePath,
